...
*/
        ...
        var cDate = new Date();
        var topPanel='<div class="datapicker-head"><span class="datapicker-head__year">'+cDate.getFullYear()+'</span><span class="datapicker-head__curent-date">'+this.regional.ru.dayNamesMin[cDate.getDay()]+", "+this.regional.ru.monthNames[cDate.getMonth()]+" "+cDate.getDate()+'</span></div>';
		html =topPanel + html+ buttonPanel;
